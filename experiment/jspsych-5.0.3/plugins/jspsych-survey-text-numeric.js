...
jsPsych.plugins['survey-text-numeric'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      // add warning div
      $("#jspsych-survey-text-" + i).append('<div id="errmsg"></div>');

      // name of current textbox
      currentTextbox = "#jspsych-survey-text-response-" + i;
    }
